...
class TrafficGenerator:
    ...
    def generate_routefile(self, seed):
        ...
        timings = np.random.uniform(size = self._n_cars_generated)
...
#TrafficGenerator(100000, 80000).generate_routefile(0)
TrafficGenerator(500000, 400000).generate_routefile(0)
TrafficGenerator(500000, 450000).generate_routefile(0)
TrafficGenerator(500000, 500000).generate_routefile(0)